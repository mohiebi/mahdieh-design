        ...
        <main className="px-6 lg:px-12 pt-32 pb-24 lg:pt-44">
          <section className="max-w-[760px] mx-auto">
            ...
            <h1 className="font-display text-6xl md:text-8xl leading-[0.9] mb-10">
              خوش آمدید<span className="text-accent">.</span>
            </h1>

            <form onSubmit={submit} className="border-t border-border pt-10 space-y-8">
              <label className="block">
                <span className="text-[11px] font-mono uppercase tracking-[0.25em] text-muted-foreground">ایمیل</span>
                <input
                  type="email"
                  dir="ltr"
                  value={data.email}
              ...
              <label className="block">
                <span className="text-[11px] font-mono uppercase tracking-[0.25em] text-muted-foreground">رمز عبور</span>
                <input
                  type="password"
                  dir="ltr"
                  value={data.password}
