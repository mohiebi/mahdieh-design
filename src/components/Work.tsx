            ...
            return (
              ...
              >
                <div className={`lg:col-span-5 ${reversed ? "lg:order-2 lg:col-start-8" : "lg:order-1"}`}>
                  ...
                  <Link to="/projects/$slug" params={{ slug: p.slug }} className="block group/title">
                  ...
                  >
                    <span className="h-px w-10 bg-foreground/60 group-hover/cta:w-16 transition-all" aria-hidden />
