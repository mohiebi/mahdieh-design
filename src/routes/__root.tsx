...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Mahdieh Baghoolizadeh — Portfolio" },
      { property: "og:description", content: "Brand strategy, visual identity & UI/UX design across Canada, UK and the Middle East." },
